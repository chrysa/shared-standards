...
- Follow the chrysa Makefile & layout standards (chrysa/shared-standards): mandatory Makefile targets (`docs/MAKEFILE-STANDARD.md`), standard layout, branch naming (`feat/<id>-desc`).
