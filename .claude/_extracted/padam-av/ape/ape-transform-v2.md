...
1. **Context** — for whom, in what situation, against what prior material?
1. **Success criteria** — what makes the output good? (measurable where possible)
1. **Output format** — structure, length, medium.
1. **Constraints** — tone, style, what to preserve, what to avoid.
