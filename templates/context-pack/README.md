...
| `DEPENDENCIES.md` | Vue des dépendances **dérivée** des manifestes/lockfiles. |
| `ecosystem-place.md` | Place dans l'écosystème (dépendances shared-standards, liens Hub/Notion). |
| `ai-config/security.md` | Pointeur sécurité (OpenBao), sans écraser un `SECURITY.md` de repo. |
| `docs/adr/INDEX.md` | Index ADR **dérivé** de `docs/adr/`. |
